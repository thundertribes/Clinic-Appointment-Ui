...
const defaultValues: Partial<BirthRecordFormValues> = {
  childMiddleName: "",
  motherMiddleName: "",
  fatherMiddleName: "",
  motherOccupation: "",
    ...
    <div className="container mx-auto space-y-6">
      <div className="flex items-center justify-between gap-4 flex-wrap">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-2xl font-bold tracking-tight">Add Birth Record</h2>
        </div>
      </div>
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Enter the details of the newborn child</CardDescription>
            </CardHeader>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Enter the details of the child's mother</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <FormField
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Enter the details of the child's father</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <FormField
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Enter medical details related to the birth</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
