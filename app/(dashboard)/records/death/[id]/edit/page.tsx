...
const deathRecord = {
  ...
  deathInfo: {
    dateOfDeath: new Date("2023-05-10"),
    timeOfDeath: "14:30",
...
export default function EditDeathRecordPage({ params }: { params: Promise<{ id: string }> }) {
  const { id } = use(params)
  const router = useRouter()
  const [activeTab, setActiveTab] = useState("personal")

  // Flatten the nested structure for the form
  const defaultValues: DeathRecordFormValues = {
    fullName: deathRecord.personalInfo.fullName,
    gender: deathRecord.personalInfo.gender as "male" | "female" | "other",
    dateOfBirth: deathRecord.personalInfo.dateOfBirth,
    age: deathRecord.personalInfo.age,
    placeOfBirth: deathRecord.personalInfo.placeOfBirth || "",
    nationality: deathRecord.personalInfo.nationality || "",
    address: deathRecord.personalInfo.address,
    maritalStatus: deathRecord.personalInfo.maritalStatus as "single" | "married" | "divorced" | "widowed",
    occupation: deathRecord.personalInfo.occupation || "",
    dateOfDeath: deathRecord.deathInfo.dateOfDeath,
    timeOfDeath: deathRecord.deathInfo.timeOfDeath,
    placeOfDeath: deathRecord.deathInfo.placeOfDeath,
    causeOfDeath: deathRecord.deathInfo.causeOfDeath,
    mannerOfDeath: deathRecord.deathInfo.mannerOfDeath as "natural" | "accident" | "suicide" | "homicide" | "undetermined" | "pending",
    attendingPhysician: deathRecord.medicalInfo.attendingPhysician,
    medicalExaminer: deathRecord.medicalInfo.medicalExaminer || "",
    autopsyPerformed: deathRecord.medicalInfo.autopsyPerformed as "yes" | "no" | "pending",
    autopsyFindings: deathRecord.medicalInfo.autopsyFindings || "",
    informantName: deathRecord.additionalInfo.informantName,
    informantRelationship: deathRecord.additionalInfo.informantRelationship,
    informantContact: deathRecord.additionalInfo.informantContact,
    notes: deathRecord.additionalInfo.notes || "",
  }
    ...
    <div className="container mx-auto space-y-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div className="flex items-center flex-wrap gap-2">
          ...
          <div>
            <h2 className="text-2xl md:text-2xl lg:text-3xl font-bold tracking-tight">Edit Death Record: {deathRecord.id}</h2>
            <p className="text-muted-foreground">Update death record information</p>
          </div>
        </div>
            ...
            <TabsContent value="personal" className="space-y-6 mt-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Update the deceased person's personal details</CardDescription>
                </CardHeader>
            ...
            <TabsContent value="death" className="space-y-6 mt-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Update details about the death</CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <FormField
            ...
            <TabsContent value="medical" className="space-y-6 mt-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Update medical details related to the death</CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <FormField
            ...
            <TabsContent value="additional" className="space-y-6 mt-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Update informant details and additional notes</CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <FormField
